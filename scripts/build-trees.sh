...
./gradlew -q run --args="dominators $1 $2 -o $5/retained-left/retained-sizes.js -e $5/retained-left/dominator-tree.js --tree"
./gradlew -q run --args="dominators $3 $4 -o $5/retained-right/retained-sizes.json -e $5/retained-right/dominator-tree.json --tree"
./gradlew -q run --args="dominators $3 $4 -o $5/retained-right/retained-sizes.js -e $5/retained-right/dominator-tree.js --tree"